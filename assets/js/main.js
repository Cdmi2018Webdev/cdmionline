jQuery(document).ready(function($){
	...
	function setForm(){
		...
		//form post;
		$('.pay-form').attr('action',baseUrl+"/response.php?gateway=payleap");
		($('#card').is(':checked')) 
				...
				if(($('#card').is(':checked'))){
					//hide get
					$('.pay-form').attr('action',baseUrl+"/response.php?gateway=payleap");
					// $('.pay-forms').attr('action','https://www.facebook.com');
				}
				else{
					$('.pay-form').attr('action',baseUrl+"/response.php?gateway=paypal");
					// $('.pay-forms').attr('action','https://www.paypal.com/cgi-bin/webscr');
					
				}
					// alert($('#card').is(':checked'))
